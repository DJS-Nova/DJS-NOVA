      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="md:col-span-1">
            <h2 className="text-2xl font-bold">DJS NOVA</h2>
        ...
        <div >
          ...
          <p className="mt-4">
            <a title="Instagram" href="https://www.instagram.com/djsnova/" target="_blank" rel="noreferrer" className=" text-gray-300/70">
        ...
        <div className="border-t border-gray-600 pt-3 mt-10">
          © 2023 DJS NOVA - All Rights Reserved
        </div>
