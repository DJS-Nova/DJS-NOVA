...
export default function NavBar() {
    ...
    <div className='flex flex-row static '>
        ...
        <div className="hidden lg:flex lg:gap-x-12">
            <a href="#" className="text-sm font-semibold leading-6 text-gray-200 hover:font-extrabold hover:shadow-xl transition-all ease-in duration-100 p-2 rounded-lg " >Home</a>
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
            ...
            <a href="#" className="text-sm font-semibold leading-6 text-gray-200 p-2 hover:bg-violet-600 rounded-md transition-all duration-500 ease-in-out border-2  border-violet-600" >Log in <span aria-hidden="true">&rarr;</span></a>
        </div>
        </nav>
